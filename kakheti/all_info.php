...
<body>
    <table width="100%">
        <tr>
            ...
            <td><a href="/kakheti/total_sale.php">თვის შედეგები</a></td>
    ...
    <div class="righttext" ><a href="https://www.apeni.ge/all_info.php">თბილისის გვერდზე გადასვლა</a>  </div>
...
<Button onclick="fdown(0)">საერთო ამონაწერი  <i class="material-icons" style="font-size:18px">&#xe258;</i></Button>
            ...
            <td class='chart3' valign="top" width='74%'>
                <div class="worning">შედეგებში არ შედის 'Tbilisi'-ს და '0 soko-nukri'-ს მონაცემები!</div><br>
