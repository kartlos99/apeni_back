...
const ERROR_CODE_NO_USER_FOUND = "NO_USER_FOUND";
const ERROR_TEXT_PASSWORD_DONT_MATCH = "password don't match!";
const ERROR_CODE_PASSWORD_DONT_MATCH = "PASSWORD_DONT_MATCH";
